...
if clientID!=-1:
    ...
    S1 = [ -0.4471,   -1.7184,    1.5323,    1.6732,    1.5586,    1.0469]
    G1 = [ -0.4471,   -1.7336,    1.7787,    1.4420,    1.5586,    1.0469]
    S2 = [-0.4471,   -1.7184,    1.5323,    1.6732,    1.5586,    1.0469]
    G2 = [-0.2647,   -1.1038,    1.1007,    1.4441,     1.4062,    0.9469]
    S3 = [-0.3447,   -1.4638,    1.6207,    1.4141,    1.4862,   1.1469]
    G3 = [-0.3447,   -1.4638,    1.6207,    1.4141,    1.4862,   -0.3828]
    ...
    # tryConfig = [startConfig, tryConfig0, tryConfig1, tryConfig2, goalConfig]
    tryConfig = [S1,G1,S2,G2,S3,G3]
